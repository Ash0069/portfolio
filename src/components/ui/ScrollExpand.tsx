...
// ─────────────────────────────────────────────────────────────
// ScrollExpand — from React Bits (reactbits.dev)
// Adapted for Next.js: "use client" + TypeScript. Its styles live
// in globals.css (.scroll-expand*) instead of a sibling .css import.
// ─────────────────────────────────────────────────────────────
...
const ScrollExpand = ({
  ...
  // Keep the live-config ref in sync without restarting scroll listeners.
  useEffect(() => {
    propsRef.current = {
      startWidth,
      startHeight,
